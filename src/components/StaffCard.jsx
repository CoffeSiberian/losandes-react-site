...
const StaffCard = ({ id, username, roleName, dateJoin }) => {
    ...
    return (
        <div
            className={`flex flex-col ${themeTatailwind.secundary.main} rounded-lg border-2 border-transparent ${themeTatailwind.primary.border_color} w-auto shadow-2xl m-4 mb-12 p-4 gap-3`}
        >
